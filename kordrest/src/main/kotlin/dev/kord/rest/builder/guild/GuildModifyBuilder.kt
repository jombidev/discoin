...
public class GuildModifyBuilder : AuditRequestBuilder<GuildModifyRequest> {
    ...
    private var _icon: Optional<dev.kord.rest.Image?> = Optional.Missing()
    public var icon: dev.kord.rest.Image? by ::_icon.delegate()

    private var _ownerId: OptionalSnowflake = OptionalSnowflake.Missing
    public var ownerId: Snowflake? by ::_ownerId.delegate()

    private var _splash: Optional<dev.kord.rest.Image?> = Optional.Missing()
    public var splash: dev.kord.rest.Image? by ::_splash.delegate()

    private var _banner: Optional<dev.kord.rest.Image?> = Optional.Missing()
    public var banner: dev.kord.rest.Image? by ::_banner.delegate()
