...
@Serializable(with = RelationShipType.RelationShipSerializer::class)
enum class RelationShipType(val code: Int) {
    ...
    public companion object RelationShipSerializer : KSerializer<RelationShipType> {
        override val descriptor: SerialDescriptor
            get() = PrimitiveSerialDescriptor("type", PrimitiveKind.INT)

        private val entriesByCode = entries.associateBy { it.code }
        override fun deserialize(decoder: Decoder): RelationShipType {
...
public data class DiscordRemovedGuildMember(
    @SerialName("guild_id")
    val guildId: Snowflake,
    val user: DiscordUserRemoveGuild
)
