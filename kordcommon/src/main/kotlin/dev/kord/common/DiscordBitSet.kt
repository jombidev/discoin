...
internal fun formatIntegerFromLittleEndianLongArray(data: LongArray): String {
...
internal fun parseIntegerToBigEndianByteArray(value: String): ByteArray = BigInteger(value).toByteArray()
