...
public data class Identify(
    val token: String,
    val capabilities: OptionalLong = OptionalLong.Missing,
    ...
    override fun toString(): String =
        "Identify(token=(hidden), properties=$properties, compress=$compress, largeThreshold=$largeThreshold, " +
                "presence=$presence)"
}
